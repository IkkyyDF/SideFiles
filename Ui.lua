if game:GetService("CoreGui"):FindFirstChild("NEXUS~") then
	game:GetService("CoreGui"):FindFirstChild("NEXUS~"):Destroy()
end
local DiscordLib = {}
...
function DiscordLib:Window(text,mainclr,ver,gameName,cls, font)
	local PresetFont = font or Enum.Font.SourceSans
	local PresetColor = mainclr or Color3.fromRGB(107, 39, 242) or _G.Color
	...
	if game.CoreGui:FindFirstChild("NexusToggle~") then
		game.CoreGui:WaitForChild("NexusToggle~"):Destroy()
	end

    ScreenGui.Name = "NexusToggle~"
    ...
    Toggle.Font = PresetFont
    Toggle.Text = "N"
    Toggle.TextColor3 = PresetColor
	...
	TopFrame.BackgroundColor3 = Color3.fromRGB(64, 64, 64)
	...
	TopFrameHolder.BackgroundColor3 = Color3.fromRGB(64, 64, 64)
	...
	function DiscordLib:Notification(titletext, desctext, btntext, btntext2, twobutton, callback, callback2)
		...
		if twobutton then
			local AlrightBtn2 = Instance.new("TextButton")
			local AlrightCorner2 = Instance.new("UICorner")

			AlrightBtn.Name = "AlrightBtn"
			AlrightBtn.Parent = Notification
			AlrightBtn.BackgroundColor3 = PresetColor
			AlrightBtn.Position = UDim2.new(0.0332369953, 0, 0.789141417 , 0)
			AlrightBtn.Size = UDim2.new(0, 150, 0, 27)
			AlrightBtn.Font = PresetFont
			...
			AlrightBtn2.Name = "AlrightBtn"
			AlrightBtn2.Parent = Notification
			AlrightBtn2.BackgroundColor3 = PresetColor
			AlrightBtn2.Position = UDim2.new(0.53332369953, 0, 0.789141417 , 0)
			AlrightBtn2.Size = UDim2.new(0, 150, 0, 27)
			AlrightBtn2.Font = PresetFont
			AlrightBtn2.Text = btntext2
			AlrightBtn2.TextColor3 = Color3.fromRGB(23, 23, 23)
			AlrightBtn2.TextSize = 13.000
			AlrightBtn2.AutoButtonColor = false

			AlrightCorner2.CornerRadius = UDim.new(0, 4)
			AlrightCorner2.Name = "AlrightCorner"
			AlrightCorner2.Parent = AlrightBtn2

			AlrightBtn2.MouseButton1Click:Connect(function()
				pcall(callback2)
				TweenService:Create(
					NotificationHolderMain,
					TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			AlrightBtn2.MouseEnter:Connect(function()
				TweenService:Create(
					AlrightBtn2,
					TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			AlrightBtn2.MouseLeave:Connect(function()
				TweenService:Create(
					AlrightBtn2,
					TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
	...
	function ServerHold:Server(text, img)
		...
		TimeGlobal.Position = UDim2.new(0.6062470865, 0, 0, 0)
		TimeGlobal.Size = UDim2.new(0, 95, 0, 39)
		TimeGlobal.BackgroundTransparency = 1
		TimeGlobal.ZIndex = 3
		TimeGlobal.Font = PresetFont
		TimeGlobal.Text = gameName.." | "..ver
		TimeGlobal.TextColor3 = PresetColor
		TimeGlobal.TextSize = 15.000
		TimeGlobal.TextXAlignment = Enum.TextXAlignment.Center
		...
		function ChannelHold:Channel(text,ico)
			...
			ChannelBtnTitle.Font = PresetFont
			...
			function ChannelContent:Button(text, callback)
                ...
                xFrame.Name = text
				xFrame.Parent = ChannelHolder
				xFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				xFrame.BackgroundTransparency = 1.000
				xFrame.Position = UDim2.new(0.0796874985, 0, 0.445175439, 0)

				Button.Name = "Button"
				Button.Parent = xFrame
				Button.BackgroundColor3 = Color3.fromRGB(23, 23, 23)
				Button.Size = UDim2.new(0, 401, 0, 38)
				Button.AutoButtonColor = false
				Button.Font = PresetFont
				Button.TextColor3 = PresetColor
				Button.TextSize = 14.000
				Button.Text = text

				xFrame.Size = UDim2.new(0, 0, 0, 38)
            ...
            function ChannelContent:Toggle(text, default, callback)
				...
				xFrame.Size = UDim2.new(0, 0, 0, 45)
			...
			function ChannelContent:Slider(text, min, max, start, suffix, callback)
				start = start or 0
                suffix = suffix or ""
				local SliderFunc = {}
				...
				xFrame.BackgroundTransparency = 1.000
				xFrame.Position = UDim2.new(0.0796874985, 0, 0.445175439, 0)
				xFrame.Size = UDim2.new(0, 401, 0, 48*1.5)

				Slider.Name = "Slider"
				Slider.Parent = xFrame
				Slider.BackgroundColor3 = Color3.fromRGB(23, 23, 23)
				Slider.BorderSizePixel = 0
				Slider.Position = UDim2.new(0, 0, 0.216560602, 0)
				Slider.Size = UDim2.new(0, 401, 0, 48)
				Slider.AutoButtonColor = false
				Slider.Font = PresetFont
				Slider.Text = ""
				...
				SliderTitle.Position = UDim2.new(0, 10, 0, -1)
				SliderTitle.Size = UDim2.new(0, 200, 0, 27)
				SliderTitle.Font = PresetFont
				...
				SliderFrame.Position = UDim2.new(0.497999996, 0, 0.657000029, 0)
                ...
                CurrentValueFrame.BackgroundTransparency = 0.5
				CurrentValueFrame.Size = UDim2.new((start - min) / (max -  min), 0, 0, 8)
				...
				Zip.Position = UDim2.new((start - min) / (max - min), -6, -0.644999981, 0)
				...
				ValueLabel.Font = PresetFont
				ValueLabel.Text = tostring(start and math.floor((start / max * max))) .. suffix
				...
				Zip.InputBegan:Connect(function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 or not dragging and input.UserInputType == Enum.UserInputType.Touch  then
						dragging = true
						ValueBubble.Visible = true
					end
				end)
				...
				Zip.InputEnded:Connect(function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 or dragging and input.UserInputType == Enum.UserInputType.Touch then
						dragging = false
						ValueBubble.Visible = false
					end
				end)
				...
				function SliderFunc:Change(tochange)
					...
					ValueLabel.Text = tostring(tochange and math.floor((tochange / max) * (max - min) + min) or 0)..suffix
			...
			function ChannelContent:Dropdown(text, list, callback)
				...
				Dropdown.Size = UDim2.new(0, 401, 0, 60)
				...
				CurrentSelectedText.Font = PresetFont
				...
				DropItemHolderLabel.Font = PresetFont
				...
				Search.Name = "Search"
				Search.Parent = DropItemHolder
				Search.BackgroundColor3 = Color3.fromRGB(42, 44, 48)
				Search.Size = UDim2.new(0, 379, 0, 29)
				Search.Font = PresetFont
				Search.PlaceholderText = "Search"
				Search.PlaceholderColor3 = PresetColor
				Search.Text = ""
				Search.TextWrapped = true
				Search.TextColor3 = PresetColor
				Search.TextSize = 14.000
				Search.BackgroundTransparency = 1
				Search.TextXAlignment = Enum.TextXAlignment.Center

				SearchCorner.CornerRadius = UDim.new(0, 4)
				SearchCorner.Name = "Search"
				...
				pcall(function()
					local function updatesearch()
						for i,button in pairs(DropItemHolder:GetChildren()) do
							if button.Name == "Item" then
								local searchText = Search.Text

								if searchText ~= "" then
									local buttonTextlower = string.lower(button.ItemText.Text)
									local buttonTextupper = string.upper(button.ItemText.Text)
									local buttonText = button.ItemText.Text
									
									if string.find(buttonTextlower, searchText) or string.find(buttonTextupper, searchText) or string.find(buttonText, searchText) then
										button.Visible = true
										if button.Visible  then
											...
											if searchCount == 1 then
												searchSize = 29
											elseif searchCount == 2 then
												searchSize = 58
											elseif searchCount >= 3 then
												searchSize = 87
											end
										end
									else
							...
							if searchSize ~= 0 then
								...
								DropItemHolder.Size = UDim2.new(0, 385, 0, searchSize)
								DropdownFrameMain.Size = UDim2.new(0, 392, 0, searchSize + 6)
								DropdownFrameMainOutline.Size = UDim2.new(0, 396, 0, searchSize + 10)
							else
								DropItemHolder.CanvasSize = UDim2.new(0, 0, 0, DropItemHolderLayout.AbsoluteContentSize.Y)
				...
				DropdownFrameBtn.MouseButton1Click:Connect(function()
					if DropTog == false then
						...
						TweenService:Create(
							ChannelHolder,
							TweenInfo.new(.5, Enum.EasingStyle.Quart),
							{CanvasSize = UDim2.new(0, 0, 0, (ChannelHolderLayout.AbsoluteContentSize.Y + DropdownFrameMainOutline.AbsoluteSize.Y))}
						):Play()
				...
				function DropFunc:Set(s)
					CurrentSelectedText.Text = s
					CurrentSelectedText.TextTransparency = 0.250
				end
				return DropFunc
			end
			...
			function ChannelContent:Colorpicker(text, preset, callback)
				...
				ColorpickerTitle.Font = PresetFont
			...
			function ChannelContent:Label(text)
				...
				Label.Size = UDim2.new(0, 401, 0, 38)
				Label.AutoButtonColor = false
				Label.Font = PresetFont
				Label.Text = ""
            ...
            function ChannelContent:Section(text,size)
                size = size or 30
				local Label = Instance.new("TextButton")
				local LabelTitle = Instance.new("TextLabel")
				local labelfunc = {}
				...
				Label.BorderSizePixel = 0
				Label.Position = UDim2.new(0.261979163, 0, 0.190789461, 0)
				Label.Size = UDim2.new(0, 401, 0, size)
				Label.AutoButtonColor = false
				Label.Font = PresetFont
				Label.Text = "<b>"..text.."</b>"
				Label.TextColor3 = PresetColor
			...
			function ChannelContent:Bind(text, presetbind, callback)
				...
				Keybind.Parent = xFrame
				Keybind.BackgroundColor3 = Color3.fromRGB(23, 23, 23)
				Keybind.BorderSizePixel = 0
				Keybind.Position = UDim2.new(0.261979163, 0, 0.190789461, 0)
				Keybind.Size = UDim2.new(0, 401, 0, 38)
				Keybind.AutoButtonColor = false
				Keybind.Font = PresetFont
				Keybind.Text = ""
